...
import 'package:c_h_flutter/login/login_widget.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<CHFlutterFirebaseUser> userStream;
  CHFlutterFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = cHFlutterFirebaseUserStream()
